...
<html>
    <head>
        ...
        <title>Star Office BJS Management</title>
...
<div class="container">
  ...
  <div class="login-box-body" style="display: flex;align-items:center; flex-direction:column; padding:15px 0; width:30vw; height:120%; border-radius:10px;">
    <h3><b>STAR </b> Office</h3>


    <form class="form-horizontal" role="form" method="POST" action="{{route('tambah.wilayah')}}">
       @csrf
        <div class="results">
      ...
      <div class="row">
        ...
        <div class="col-xs-4" style ="display:flex; justify-content:flex-start; width:100%">
          <button type="submit" style="width: 100%"  class="btn btn-primary btn-lg btn-block btn-flat">Tambah</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
